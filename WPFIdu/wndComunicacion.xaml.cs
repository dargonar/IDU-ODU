  ...
  public delegate void OnModoEnsayoIDU(int argModoEnsayoIDU);
    ...
    private void btnMantenimientoModelos_Click(object sender, RoutedEventArgs e)
    {
      try
      {
        ...
        if (OnModoEnsayoIDU!=null)
          OnModoEnsayoIDU(int.Parse(ConfigurationManager.AppSettings["ModoEnsayoIDU"]));
