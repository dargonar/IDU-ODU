    ...
    private void btnClose_Click(object sender, RoutedEventArgs e)
    {
      ...
      private void btnLeerParametros_Click(object sender, RoutedEventArgs e)
      {
        if (!WPFiDU.BL.ManagerUsuarios.sfUser.IsInRole(iDU.CommonObjects.Role.Operador))
        {
          ...
          try
          {
              ...
              if (ltvEnsayo.SelectedIndex < 0)
                  return;
              mParam = ltvEnsayo.SelectedItem as ParametrosEnsayo;
              param_man.Dispose();
      ...
      private void btnSobreescribir_Click(object sender, RoutedEventArgs e)
      {
        ...
        try
          ...
          {
              logger.ErrorFormat("btnSobreescribir_Click(object sender, RoutedEventArgs e):: Message:'{0}', StackTrace:'{1}', InnerException:'{2}' "
            , ex.Message
            , ex.StackTrace
            , ex.InnerException != null ? ex.InnerException.Message : "");
              excepcion formularioexcepciones = new excepcion(ex);
