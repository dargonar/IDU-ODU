...
namespace WPFiDU.Etiquetas
{
  class PosicEtiquetaBulto
  {
    ...
    public PosicElement CodigoAAE = new PosicElement();
    public PosicElement FixAAE = new PosicElement();
    public PosicElement EANBarCode = new PosicElement();

    public PosicElement NroSerie_BarCode = new PosicElement();
    public PosicElement NroSerie_Small   = new PosicElement();   
    ...
    public PosicEtiquetaBulto(string[] fileLines)
    {
      ...
      this.CodigoAAE= new PosicElement(fileLines[25]);
      this.FixAAE = new PosicElement(fileLines[26]);
      this.EANBarCode = new PosicElement(fileLines[27]);

      this.NroSerie_BarCode = new PosicElement(fileLines[28]);
      this.NroSerie_Small = new PosicElement(fileLines[29]);
    }
  }
}
