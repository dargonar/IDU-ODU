...
<div id="ctr" align="center">
  <div class="login">
    ...
    <div class="login-text">
      ...
      <p>¡<?php echo __('Bienvenido a', array(), 'sf_admin_dash'); ?><br/> <?php echo sfAdminDash::getProperty('site'); ?>!</p>
      <p><?php echo __('Consola de administración.', array(), 'sf_admin_dash'); ?></p>
    </div>
