...
<?php if ($sf_user->isAuthenticated()): ?> 
  ...
  <div id='sf_admin_menu'>    
    ...
    <?php if (sfAdminDash::getProperty('logout') && $sf_user->isAuthenticated()): ?>
      <div id="logout">
        <?php echo link_to(__('Logout', null, 'sf_admin_dash'), sfAdminDash::getProperty('logout_route', '@sf_guard_signout ')); ?> <?php echo $sf_user; ?>
        &nbsp;&nbsp;&nbsp;
        <a href="/help/ayuda.pdf" target="_blank" title="Ayuda en formato PDF">Ayuda</a>
      </div>
    <?php endif; ?>
    <div class="clear"></div>
  </div>
